...
function buildSeo(columns, tech, cti = [], essays = []) {
  ...
  const llms = [
    ...
    "> Domain map: docs=Columns; tech=TechDoc; cti=CTI; essays=Essays; play=Playground; lab=TokenForge; research; vibequant.cc=hub.",
    "",
    "## Site",
    `- [Home](${SITE}/)`,
    ...
    `- [Lab](${absoluteSitePath(SITE_LAB)}) — TokenForge`,
