...
const SLUG_OVERRIDES = {
  ...
  "Game-Theory/Crouching-Tiger- Hidden-Dragon.md": "crouching-tiger-hidden-dragon",
...
function buildSeo(columns, tech, cti = [], essays = []) {
  ...
  const llms = [
    ...
    "> Domain map: docs=Columns; tech=TechDoc; cti=CTI; essays=Essays; play=Playground; lab=DART Monitor; research; vibequant.cc=hub.",
    "",
    "## Site",
    `- [Home](${SITE}/)`,
    ...
    `- [Lab](${absoluteSitePath(SITE_LAB)}) — DART Monitor`,
