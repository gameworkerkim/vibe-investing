...
export const CTI_GROUP_RULES = [
  ...
  { id: "dprk", title_ko: "북한 · Lazarus · Kimsuky", title_en: "DPRK", match: [/lazarus/i, /kimsuky/i, /kimsuki/i, /scarcruft/i, /dprk/i, /pebbledash/i, /taikobridge/i, /modoo/i, /newjistock/i, /bank-hackers/i, /north.?korea/i] },
  ...
  { id: "korea-breach", title_ko: "한국 침해 · 국내", title_en: "Korea Breaches", match: [/kakao/i, /tving/i, /lineyahoo/i, /fastcampus/i, /odido/i, /iitp/i, /jsdf/i, /breac/i, /cu_breach/i, /github_kr/i, /copyfail/i, /0822-column/i, /cert.?authority/i, /인증기관/i] },
  ...
  { id: "crypto-web3", title_ko: "크립토 · Web3", title_en: "Crypto · Web3", match: [/coldcard/i, /litecoin/i, /kelpdao/i, /ostium/i, /eviltokens/i, /aicryptojack/i, /crypto/i, /sanctions/i] },
...
export const FEATURED_CTI_PATHS = [
  "CTI-2026-0910-KIMSUKI.md",
  "CTI-2026-0822-Column-KR.md",
  "CTI-2026-0804-COLDCARD-RNG_KR.md",
