...
export const COLUMN_GROUP_RULES = [
  ...
  { id: "ai-llm", title_ko: "AI · LLM · 빅테크", title_en: "AI · LLM · Big Tech", match: [/ai_revolution/i, /ai-education/i, /ai-bottleneck/i, /ai-idc/i, /high-power-datacenter/i, /ai bouble/i, /ai_bouble/i, /ai_hacking/i, /ai_trading/i, /deepseek/i, /claude/i, /meta\//i, /oracle/i, /jane street/i, /llm_supply/i, /bigtech/i, /kimi/i, /grok/i, /alibaba/i, /qwen/i, /distillation.?shell/i, /super.?programmer/i] },
  ...
  { id: "korea-hacking", title_ko: "한국 · 해킹", title_en: "Korea · Hacking", match: [/national-diplomatic/i, /외교원/i, /hacking-incident/i, /\/hacking\//i, /backdoor/i, /endless.?doors/i, /kimsuky/i, /north-korea/i, /\/security\//i, /sogou/i] },
  { id: "korea", title_ko: "한국 · 코리아 디스카운트", title_en: "Korea", match: [/korea/i, /주식시황/i, /msci/i, /starbucks/i, /seoul/i, /kpop/i, /\/idol\//i, /ive-starship/i, /toss /i, /기레기/i, /골드만/i, /cyworld/i, /\/vc\//i, /kakao.?ventures/i] },
  ...
  { id: "industry", title_ko: "산업 · 소비", title_en: "Industry · Consumer", match: [/uber/i, /netflex/i, /netflix/i, /mokrak/i, /luxury/i, /webtoon/i, /kidult/i, /ford/i, /adobe/i, /voce/i, /brain/i, /bouble/i, /cyber wrecker/i, /518/i, /startup/i, /shelf-life/i, /\/k11\//i, /adrian-cheng/i, /bending.?spoons/i, /\/comics\//i, /x-men/i, /pink.?econom/i, /post-covid/i, /end-of-drink/i, /drink.?age/i, /k-movie/i, /screen.?quota/i, /china-culture/i, /\/sports\//i, /us.?open/i, /\/commerce\//i, /refund/i, /abandoned.?dog/i] },
];
...
export const FEATURED_COLUMN_PATHS = [
  "Abandoned-Dog/Abandoned-Dog-Holiday-Issue.md",
  "VC/Kakao-Ventures-Issue.md",
  "commerce/refund.md",
  "Super-Programmer-Opinion.md",
  "security/Sogou-Hacking.md",
  "Insider trading/KPMG-Polymarket-Scandal.md",
  "Sports/US-Open.md",
  ...
  "North-Korea/Kimsuky-AI-Issue.md",
  "Privacy/LG-Smart-TV-Issue.md",
  "AI_Revolution/Llm Token-Saving-Full-Writers-Marketers.md",
  "The-Economics-of-Expos\u00e9s.md",
  "K-Movie/Screen-Quota-System.md",
  "AI Bouble/Nvidia-Fait-Accompli.md",
  "AI-Bottleneck/Column-AI-privacy-public-safety.md",
  "Post-COVID/End-of-Drink-age.md",
  "comics/X-Men-The-Economics-of-the-Borderline-People.md",
  "Cyworld/Cyworld-True-Mother-Guestbook.md",
  "AI-Education/AI-Era-Developer-Flow-and-Communication.md",
  "Travel-Rule/Travel-Rule-1won-Market-Shift.md",
  "Bending spoons/Bending spoons playbook analysis.md",
  "Windows10/EOD-Win10-China.md",
  "SSD/SSD-Power-OFF-Retention-Risk.md",
  "Hacking/BackDoor-ENDLESS-DOORS.md",
