...
from vi_quant.context_base import ContextBase, ContextMeta
from vi_quant.json_convertors import (
    encode_date_or_str,
    decode_date_or_str,
...
class RiskKey(namedtuple('RiskKey', ('provider', 'date', 'market', 'params', 'scenario', 'risk_measure'))):
    @property
    def ex_measure(self):
        from vi_quant.target.common import RiskRequestParameters  # noqa
...
class Base(ABC):
    ...
    def clone(self, **kwargs):
        ...
        **Examples**
        ...
        >>> from vi_quant.instrument import IRCap
        >>> cap = IRCap('5y', 'GBP')
        >>>
...
class Priceable(Base):
    ...
    def dollar_price(self):
        ...
        **Examples**
        ...
        >>>
        >>> from vi_quant.markets import PricingContext
        >>>
        >>> with PricingContext():
    ...
    def calc(self, risk_measure, fn=None):
        ...
        :param risk_measure: the risk measure to compute, e.g. IRDelta (from vi_quant.risk)
        ...
        **Examples**
        ...
        >>> from vi_quant.instrument import IRCap
        >>> from vi_quant.risk import IRDelta
        >>>
        >>> cap = IRCap('1y', 'USD')
        ...
        >>> from vi_quant.instrument import EqOption
        >>> from vi_quant.risk import EqDelta
        >>>
