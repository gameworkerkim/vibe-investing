...
from vi_quant.common import PricingLocation, Currency
from vi_quant.data import Dataset
from vi_quant.errors import MqRequestError
...
class ViCalendar:
    ...
    def get(calendars: Union[str, Tuple], skip_valid_check=True):
        return ViCalendar(calendars, skip_valid_check)
    ...
    def holidays(self) -> Tuple[dt.date, ...]:
        currencies, exchanges = _split_list(self.__calendars, ViCalendar.is_currency)
