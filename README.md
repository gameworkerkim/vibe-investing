...
AI 투자(Vibe Investing) 큐레이션 어썸 시리즈 · 시장 분석 칼럼 7편 · AI 트레이딩 도구 3종 (Harness Quant v2 + Earnings Momentum Agent + Nasdaq-BTC Coupling Bot) · **SSRN 학술 논문 1편 (Phase 1, 2026-04-25 게재)** 을 다룹니다. 리서치하는 마켓은 미국 나스닥, S&P500, 가상화폐, 유럽 명품 섹터, 크립토-주식 상관관계입니다. 인공지능은 엑셀과 같은 도구입니다. LLM은 만능이 아니며, 모델을 읽는 인간의 통찰력이 가장 중요하다고 믿습니다. 지금 비트코인과 나스닥의 커플링의 시그널이 강력한 가운데 우리는 소음과 신호에서 신호를 인공지능이라는 도구를 통해 발견할 수 있습니다.

2026년 4월 25일 새로 추가된 LLM을 이용한 Awesome Claude Quant Scripts를 통해서 나만의 퀀트 전략을 수립할 수 있게 되었습니다. **같은 날 첫 SSRN Working Paper "The 72-Hour Shock?" (Abstract ID 6632838) 이 게재되었습니다.**
...
### 📄 학술 논문 (SSRN Working Papers) 🆕

| # | Phase | 제목 | 상태 | SSRN ID |
| --- | --- | --- | --- | --- |
| 1 | **Phase 1** | [**The 72-Hour Shock? Preliminary Evidence from 52 Token Unlock Events on Binance**](https://ssrn.com/abstract=6632838) | ✅ Published 2026-04-25 | **[6632838](https://ssrn.com/abstract=6632838)** |
| 2 | Phase 2 | Robustness Extension (N≥200) + 365-day cliff pre-registration | 📅 Q4 2026 예정 | TBD |
| 3 | Phase 3 | [**Disclosure Timing Around Token Unlocks**](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/%20Disclosure%20Timing%20Around%20Token%20Unlocks) | 📋 Design complete | — |
| 4 | Phase 4 | [**ChainWar: Chain-level Comparison**](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/ChainWar) | 📋 Ideation | — |

> **인용 시**: *Kim, HoKwang. (2026). The 72-Hour Shock? Preliminary Evidence from 52 Token Unlock Events on Binance. SSRN Working Paper No. 6632838. https://ssrn.com/abstract=6632838*
...
이 레포는 vibe investing의 **현재 도구·솔루션 지형을 정리**하고, **시장의 흐름을 분석한 칼럼**을 함께 공개하며, **직접 만들고 있는 레퍼런스 구현체**도 함께 공유합니다. **2026년 4월부터는 이 작업 위에 공식 학술 연구 트랙(SSRN Working Papers)을 추가로 올려, 실증 분석을 peer-reviewable 형태로 확장하고 있습니다.**
...
### 14. SSRN 학술 논문 Phase 1 — The 72-Hour Shock? (토큰 언락 이벤트 실증 분석) 🆕📄

[**📄 SSRN 논문 보기 (Abstract ID 6632838)**](https://ssrn.com/abstract=6632838) · [**📂 GitHub 재현 패키지**](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/Token%20unlock%2072h%20shock%20analysis%20)

> *"토큰 언락은 내일의 날씨와 같다. 일정이 이미 쓰여 있다.*
> *그런데도 시장은 매번 놀란다."*
>
> — HoKwang Kim, SSRN 6632838

**2026년 4월 25일 SSRN(Social Science Research Network)에 정식 게재된 첫 학술 논문.** 이 레포의 칼럼·도구들이 *실무 분석*이라면, 이 논문 시리즈는 그 위에 얹은 *학술 연구 트랙*입니다. Keyrock(2024)의 16,000건 언락 이벤트 연구를 확장하여, 바이낸스 상장 토큰 52개 언락 이벤트의 **72시간 내 가격 충격을 비트코인 조정 수익률 기반**으로 검증했습니다.

**논문 기본 정보**:

* **📄 제목**: *The 72-Hour Shock? Preliminary Evidence from 52 Token Unlock Events on Binance*
* **🔖 SSRN Abstract ID**: [6632838](https://ssrn.com/abstract=6632838)
* **📅 게재일**: 2026년 4월 25일
* **👤 저자**: HoKwang Kim (Independent Researcher · Betalabs Inc. CEO, 개인 자격)
...
| # | 발견 | 통계 |
| --- | --- | --- |
| 1️⃣ | **52개 중 46건(88.5%)이 언락 후 72시간 내 음의 수익률** | 이항 검정 p = 2.2 × 10⁻⁹, 17개 검정에 대한 **Bonferroni 교정 후에도 유의** |
| 2️⃣ | **효과가 BTC 시장 국면에 의해 조절되지 않음** | ANOVA p = 0.24. ETH, Top-10 시총 지수 벤치마크에도 강건 |
| 3️⃣ | ⚠️ **[탐색적] 상장 후 365일 기념일 ±60일 내 14건 전원이 음의 수익률** | 사후적 발견 — 사전등록된 표본외 재현 필요 |

**논문의 핵심 기여**:

* 📊 Keyrock(2024)의 30일 저성과 현상을 **72시간 창으로 시간적 분해**
* 📉 평균 수익률 **-16.97%**, 중앙값 -18.57%
* 🔬 **17개 공식 가설 검정 + Bonferroni 교정** 전면 적용
* 📐 OLS 다변량 회귀로 **언락 규모가 시장 베타와 무관한 독립 변수임을 확인** (β = -0.0089, p = 0.006)
* 🔄 **강건성 검사 9종** — 기간 하위분할, 대체 창(24h/48h/96h), Ethereum 벤치마크, Top-10 지수 벤치마크, 규모 필터 등
* 📂 **완전한 재현성** — 10개 CSV 데이터셋 + 8개 Python 스크립트, `python reproduce_all_tables.py` 한 줄로 모든 표 재생성

**법적·학술적 단서조항**:

* ✅ **통계적 연관성만 주장** — 인과관계 주장 없음
* ✅ **개별 프로젝트 비난 없음** — 집계 통계 기반
* ❌ **투자 조언 아님** — Section 7.2에 명시적 경고
* ❌ **트레이딩 신호 아님** — Appendix E 백테스트는 예시용
* ⚠️ **365일 클리프는 탐색적**, 사전등록된 재현 필수

**GitHub 공개 성과** (2026-04-17 공개 ~ 2026-04-25 SSRN 게재, 8일간):
...
Unique Cloners:  672
Total Views:     4,089
Unique Visitors: 1,418
LinkedIn 유입:   972 views (52.7%)
Facebook 유입:   243 views (13.2%, 한국어권)
```

→ **SSRN 게재 이전에 이미 672명의 실 검토자가 데이터와 코드를 다운로드**. Working paper가 학술 커뮤니티에 진입하기 전부터 실무자·연구자에게 peer review된 특이한 케이스.

**연구 프로그램 로드맵** (vibe-investing 연구 트랙):

| Phase | 주제 | 상태 | 목표 시기 |
| --- | --- | --- | --- |
| **Phase 1** | 72-Hour Shock 분석 (N=52) | ✅ **SSRN 6632838 게재** | 2026-04-25 |
| Phase 2 | Robustness 확장 (N≥200) + 365일 클리프 사전등록 재현 | 📅 계획 | Q4 2026 |
| Phase 3 | [Disclosure Timing Around Token Unlocks](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/%20Disclosure%20Timing%20Around%20Token%20Unlocks) (+ LLM 탐지 도구) | 📋 설계 완료 | Q1-Q2 2027 |
| Phase 4 | [ChainWar: 체인별 상장 성과 비교](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/ChainWar) | 📋 아이디어 노트 | Q3-Q4 2027 |
...
@article{kim2026token72h,
  ...
  note    = {Replication: \url{https://github.com/gameworkerkim/vibe-investing}}
}
```
...
* 🎓 **첫 peer-citable 학술 산출물** — 칼럼·도구에 이어 정식 working paper로 확장
* 🔬 **완전 재현 가능** — 데이터 + 코드 + 문서 + 환경 모두 공개. `pip install -r requirements.txt && python reproduce_all_tables.py` 한 줄
* 📊 **Bonferroni-robust** — 17개 검정에 대한 교정 후에도 p < 10⁻⁹
* 🇰🇷 **한국어 + 영문 동시 발행** — 아시아 시장 독자 동시 도달
* 🤝 **학술 네트워크 진입** — Cryptocurrency Research eJournal, Google Scholar 색인 진행 중
* ⚠️ **탐색적 발견을 정직하게 표시** — 365일 클리프는 post-hoc임을 명시

**알려진 한계** ⚠️:

* **N=52는 소규모** — Keyrock의 16,000건 대비 0.3%. 제목에 "*Preliminary Evidence*"와 "?"가 들어간 이유. Phase 2에서 N≥200으로 확장 예정
* **2023-2025년 바이낸스 한정** — 외적 타당성 제한. 다른 거래소, 다른 기간 일반화 미검증
* **인과관계 없음** — 관찰 연구의 본질적 한계. 언락 스케줄이 외생적이어도 프로젝트 특유 요인이 동시 변화 가능
* **365일 클리프는 사후적** — 재현 전까지 확증된 anomaly로 취급 금지
* **백테스트는 예시용** — 슬리피지, 펀딩비, 차용 가용성, 규제 제약 실제 반영 시 수익률 크게 감소 예상

**관련 데이터셋 (10종, 모두 CSV 공개)**:

* `01_binance_token_unlock_events_2023_2025.csv` — 52개 언락 이벤트 원본
* `02_hypothesis_verification_summary.csv` — 13개 지표 검증 요약
* `03_recipient_category_analysis.csv` — 수취인 7개 카테고리 분석
* `04_btc_relative_performance_matrix.csv` — 5개 BTC 국면 분해
* `05_unlock_trading_strategies_backtest.csv` — 10개 백테스트 설정
* `06_hourly_prices_events.csv` — T-24h ~ T+72h 시간별 가격 (5,044 rows)
* `07_top10_index_constituents.csv` — 분기별 Top-10 지수 구성
* `08_eth_prices_events.csv` — 이더리움 벤치마크 가격
* `09_tested_hypotheses_list.csv` — 17 + 1 가설 전체 목록
* `10_regression_analysis_inputs.csv` — OLS 회귀 입력값

**Phase 3·4 아이디어 노트** (실행 전 연구 설계):

* 📋 [**Phase 3: Disclosure Timing Around Token Unlocks**](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/%20Disclosure%20Timing%20Around%20Token%20Unlocks) — 재단의 공시 타이밍 × 언락 × KOL 증폭 × LLM 탐지 도구
* 📋 [**Phase 4: ChainWar**](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/ChainWar) — BNB Chain vs ERC-20 vs Solana 상장 성과 비교 (2020-2025)
...
**그리고 실무 분석에만 머무는 것도 한계가 있습니다.** 2026년 4월부터는 축적된 실무 관찰을 **정식 학술 논문 (SSRN Working Papers)** 형태로도 공개하고 있습니다. 가설 설정 → 데이터 수집 → 통계 검정 → Bonferroni 교정 → peer-citable 형태 정리라는 학술적 엄밀성을 거친 결과물은, 칼럼이 도달할 수 없는 수준의 주장 강도와 재현성을 제공합니다. 🆕
...
* **학술적 주장을 peer-citable working paper로 정식 공개**합니다 🆕
...
* 📄 **SSRN 6632838 — 72-Hour Shock 논문**: [https://ssrn.com/abstract=6632838](https://ssrn.com/abstract=6632838) — 22페이지 영문 원본
* 📂 **한국어 완역본**: `Token_Unlock_72h_Shock_SSRN_v3_1_KR.pdf` (20페이지, GitHub에 PDF/DOCX/MD 3종)
* 💻 **재현 패키지**: [GitHub 폴더](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/Token%20unlock%2072h%20shock%20analysis%20) — 10 CSV + 8 Python 스크립트, 한 줄로 모든 표 재현
* 📋 **다음 Phase 미리보기**:
  * Phase 3 IdeaNote — [Disclosure Timing](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/%20Disclosure%20Timing%20Around%20Token%20Unlocks)
  * Phase 4 IdeaNote — [ChainWar](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/ChainWar)
...
* 🆕 **학술 논문 재현**: [SSRN 6632838 재현 패키지](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/Token%20unlock%2072h%20shock%20analysis%20) — `python reproduce_all_tables.py`로 모든 통계 표 재생성 (Succeeded: 8/8)
...
* 🆕 **토큰 언락 SSRN 논문**: 10 CSV (52 events + 17 hypotheses + 5 regimes + 10 strategies + 5,044 hourly prices)
...
* 🆕 **토큰 언락 샷 베팅 위험**: [SSRN 6632838 논문 Section 7.2 + Appendix E](https://ssrn.com/abstract=6632838) — 88.5% 음수 확률의 backtest 수익률은 슬리피지·펀딩비·차용 제약·규제 리스크 미반영
...
* 🆕 **SSRN Working Paper Phase 1** — *The 72-Hour Shock?* (Abstract ID 6632838, 2026-04-25 게재, 8일간 672 unique cloners)
...
* 🆕 **SSRN Working Paper Phase 2** — N≥200 확장 + 365-day cliff 사전등록 재현 (Q4 2026 목표)
* 🆕 **SSRN Working Paper Phase 3** — [Disclosure Timing Around Token Unlocks](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/%20Disclosure%20Timing%20Around%20Token%20Unlocks) + LLM 탐지 도구 (Q1-Q2 2027 목표)
* 🆕 **SSRN Working Paper Phase 4** — [ChainWar: 체인별 상장 성과 비교](https://github.com/gameworkerkim/vibe-investing/tree/main/01.Trading%20Strategy/ChainWar) (Q3-Q4 2027 목표)
...
```
어썸 큐레이션:    3개 (총 50+ 도구 평가 + 8대 전략 + 30+편 학계 원전)
칼럼:             7개 (총 70,000+ 단어)
직접 개발 도구:   3개 (Harness Quant v2 + Earnings Momentum Agent + Nasdaq-BTC Coupling Bot)
                   → 총 23개 시나리오·파이프라인·regime 단계
학술 논문:        1편 SSRN 게재 (6632838) + 2편 IdeaNote 완성  ← 🆕
                   → Phase 1 ✅ / Phase 2 planned / Phase 3 design complete / Phase 4 ideation
백테스트 로그:    24개월 × 월간 리밸런싱 = 768 의사결정
                   + 26 분기 상관관계 추적 (커플링 봇)
                   + 17개 공식 가설 검정 (SSRN 논문, Bonferroni 교정)
공개 데이터셋:    14+ CSV (총 1,400+ 데이터 포인트)
                  ...
                  - 🆕 토큰 언락 52 이벤트 + 17 hypotheses + 5,044 시간별 가격 + 10 strategies
오픈소스 Python:  Nasdaq-BTC Coupling Bot 547 lines (10 classes, 18 functions)
                   + 🆕 SSRN 재현 스크립트 8종 (binomial + ANOVA + regression + robustness + backtests)
프롬프트 템플릿:  Awesome Claude Quant Scripts 13개 (전략별 8개 + 범용 T1~T5)
검증된 출처:      125+ 학술 페이퍼·공식 문서·산업 보고서
SSRN 인용 가능:   1편 (HoKwang Kim 2026, SSRN Working Paper No. 6632838)  ← 🆕
지원 언어:        한국어 (영문 요약 포함) + 🆕 SSRN 논문 영문 원본 + 한국어 완역본
GitHub 8일 성과:  🆕 74 stars · 12 forks · 2,024 clones · 672 unique cloners
```
...
* 🎓 **SSRN 논문에 대한 방법론적 피드백** 🆕 — Phase 2 확장(N≥200) 협업, 대체 표본 제공, 통계 검정 개선 제안
* 📄 **학술 인용** 🆕 — 본 연구를 이용한 paper/thesis 작업 시 Abstract ID 6632838 인용 환영
...
* 🆕 **SSRN 논문(6632838)의 모든 통계적 발견은 "Preliminary Evidence"로 명시되어 있습니다.** 논문 자체가 투자 조언이 아니며, Appendix E의 10개 백테스트 전략은 illustrative only입니다. 실거래 구현 시 슬리피지, 펀딩비, 차용 가용성, 규제 제약으로 인해 in-sample 수익률 대비 실질 성과가 크게 감소합니다. 365-day cliff 발견은 post-hoc이며 사전등록된 재현 전까지 확증된 anomaly로 취급하지 마십시오
...
Independent Researcher · Betalabs Inc. CEO · CyworldZ CEO · 개발자 · Web3 Investor
Web3, 블록체인, AI 트레이딩, 암호화폐 시장미시구조 연구 영역에서 활동하고 있습니다.

* 📧 [gameworker@gmail.com](mailto:gameworker@gmail.com)
* 🔗 [GitHub @gameworkerkim](https://github.com/gameworkerkim)
* 🔬 [ORCID 0009-0002-0962-2175](https://orcid.org/0009-0002-0962-2175) 🆕
* 📄 [SSRN Author Page](https://ssrn.com/abstract=6632838) 🆕

이 레포는 AI를 활용한 창업가로서 얻은 인사이트를 바탕으로 만들어졌습니다. 2026년 4월부터는 축적된 실무 관찰을 학술 논문(SSRN Working Papers) 형태로도 공개하기 시작했습니다.
...
🆕 **SSRN 학술 논문 인용** 시 APA/BibTeX/Chicago 형식은 위 섹션 14 참조. Abstract ID `6632838`과 정식 인용 정보를 반드시 기재해주십시오.
...
***"Token unlocks are like tomorrow's weather.  
The schedule is already written.  
Yet the market acts surprised, every time."***  
*"토큰 언락은 내일의 날씨와 같다.  
일정이 이미 쓰여 있다.  
그런데도 시장은 매번 놀란다."*  
— SSRN Working Paper 6632838 (72-Hour Shock) 🆕
