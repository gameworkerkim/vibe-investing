<!--
---
title: "항공사 마일리지는 어떻게 우리를 묶어두는가?"
title_en: "How Airline Miles Lock Us In — And Why We Should Opt Out"
subtitle: "그리고 왜 우리는 스스로 풀려나야 하는가?"
description: "대한항공·아시아나 마일리지 통합(탑승 1:1·제휴 0.82)·전환비용·부채 회계. 체리피커 전략과 일상 락인 탈출법. 투자 권유 아님(2026-09)."
abstract: |
  Korean behavioral-econ column on airline mileage lock-in (not investment advice), Sep 2026.
  FFP history from Texas International/AAdvantage; switching costs, status ladders, deferred-revenue liability.
  Korean Air reform fights 2019–2023; KAL–Asiana FTC-approved merge plan Sep 2026 (separate 10y Asiana pot; 1:1 flown / 0.82 partner; usage floors).
  Thesis: loyalty is leave-prevention; cherry-picking and KRW-value math beat lock-in.
summary_for_ai: |
  Korean consumer/policy column (not investment advice), 2026-09-18, group industry, Mileage/Airline-Mileage-Lockin.
  Concepts: switching cost, goal gradient, mental accounting, endowment, status quo bias; FTC usage mandates as lock-in paradox.
  Practical: zero-base yearly review, per-mile KRW value, spend before rule changes, avoid prepaid traps.
date: 2026-09-18
updated: 2026-09-18
...
featured: true
featured_rank: -7
og_image: "https://vibequant.cc/og/airline-mileage-lockin.jpg"
image: "https://vibequant.cc/og/airline-mileage-lockin.jpg"
...
![아시아나·대한항공 항공기 — 항공 마일리지 락인 칼럼 썸네일](./images/airline-mileage-lockin.jpg)
...
여기에 **등급 사다리**가 더해진다. 모닝캄, 모닝캄 프리미엄, 밀리언 마일러처럼 층층이 설계된 등급은 "조금만 더 타면 다음 등급"이라는 압박을 끊임없이 만들어낸다. 연말이 되면 등급 유지를 위해 굳이 필요 없는 비행을 하는 '마일리지 런(mileage run)'이라는 행동이 생길 정도이다.

그리고 잘 알려지지 않은 사실이 하나 있다. 회계상 마일리지는 항공사에게 회계적으로 **빚**이라는 것이다. 마일리지는 고객이 사용하기 전까지 부채(이연수익)로 잡히기 때문에, 항공사 입장에서는 고객이 마일리지를 쓰기 어렵게 만들거나 공제 기준을 올리면 장부상 부채가 줄어드는 효과가 생긴다. 소비자가 '재산'이라 믿는 것이 항공사에게는 '줄이고 싶은 부채'라는 비대칭, 여기에 마일리지 문제의 본질이 있다.
