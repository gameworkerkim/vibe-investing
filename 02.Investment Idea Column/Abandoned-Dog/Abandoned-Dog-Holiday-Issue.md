...
명절은 사람에게 가족 간 **'만남'**의 시간이다. 어떤 반려동물에게는 **'이별'**의 시간이다. 농림축산검역본부 자료를 바탕으로 한 집계(2025년 9월 24일 관련 보도)에 따르면, **2020년부터 2025년까지 설·추석 연휴 기간에 유기된 반려동물이 5,900마리 이상**이다. 그리고 그 숫자 안에 뚜렷한 규칙이 하나 있다. **연휴가 길수록 유기동물 수가 커지는 경향**이 관측된다는 것이다.
