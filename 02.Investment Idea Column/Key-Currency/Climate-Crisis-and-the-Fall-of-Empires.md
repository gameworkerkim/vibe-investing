...
description: "몽골 다우기·14세기 한랭·교초·홍건적·조운. 당·조선·흑사병 유럽 대조. 호르무즈·오데사 조운 구조. PNAS·Nature."
abstract: |
  원(1271–1368) 97년—몽골 Pluvial로 흥기, 14세기 한랭·황하 범람·교초 붕괴·백련교·조운 차단으로 대도 함락.
  기후 단독 원인론은 위험. 경제·사회·정치·종교 취약 구조 위 충격의 되먹임.
  대조: 당(같은 급소), 조선 경신대기근(견딤), 흑사병 서/동유럽(재협상 vs 재판농노).
  현대: 호르무즈·흑해 오데사=조운형 급소. 통화 신뢰·공급망·포용·정책 지평. 투자 권유·학술 자문 아님.
summary_for_ai: |
  Korean history/climate column (not investment advice), 2026-08-31, group macro-geo, Key-Currency series.
  Thesis: climate stress-tests depleted buffers—does not alone cause empire fall (Yuan 1271–1368).
  Rise: Mongol Pluvial 1211–1225 (PNAS Pederson/Hessl). Fall: Wolf Minimum cold, Yellow River 1344, 1351 corvée → Red Turban, grain route cut → 1368 Dadu.
  Layers: jiaochao collapse, 4-tier society, succession chaos, plague (Nature 2022 Kyrgyzstan—uncertain pathogen link).
  Contrasts: Tang chokepoint failure; Joseon Gyeongsin famine survival; Black Death W. Europe renegotiation vs E. Europe second serfdom.
  Modern: Hormuz ≈20% oil, Odessa ≈90% Ukraine grain export—same single-pipe logistics as Yuan caoyun. Certainty table.
date: 2026-08-30
updated: 2026-08-31
