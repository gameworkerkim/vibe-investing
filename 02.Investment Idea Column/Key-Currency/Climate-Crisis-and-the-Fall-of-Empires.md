...
```
[구조적 취약성]                     [기후 충격]
정치 불안 (26년 9황제)              14세기 한랭화
민족적 배제 (인재 90% 미사용)        극단 기상 변동성 증가
종교·귀족 면세 (과세 기반 축소)       황하 대범람 (1344)
        │                                │
        ▼                                ▼
   재정 적자 만성화  ◀───────────  구휼 수요 폭증 + 세수 급감
        │
        ▼
   교초 남발 → 화폐 신뢰 붕괴 (1350 지정교초)
        │
        ▼
   구휼·행정 집행 능력 상실
        │
        ▼
   무리한 대규모 노역 징발 (1351 황하 치수)
        │
        ▼
   백련교 네트워크 + 미륵·명왕 이념 → 홍건적의 난 (1351)
        │
        ▼
   조운 차단 (방국진·장사성) → 대도 기근
        │
        ▼
   지방 통제 상실 → 군벌화 → 1368 대도 함락
```
