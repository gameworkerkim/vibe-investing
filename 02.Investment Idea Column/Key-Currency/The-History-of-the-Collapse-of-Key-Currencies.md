...
description: "드라크마·데나리우스·솔리두스·교초·페소 데 오초·파운드. 기축통화 12사례와 달러 부채 40조. 침식 vs 붕괴, 그리고 달러 표시 자산을 어떻게 볼 것인가. 투자 권유 아님."
abstract: |
  아테네 드라크마부터 달러까지 12개 기축통화의 성장·통용·몰락. 전쟁 재정→함량 저하→그레샴 법칙이 반복.
  솔리두스 700년 vs 아테네 27년. 페트로달러·국채 40조·스테이블코인. 붕괴가 아니라 파운드식 침식.
  달러 표시 자산: 일부 유지, AI 보수적, 금은 보험, 인도·아프리카 위성, 올웨더. 투자 권유·학술 자문 아님.
summary_for_ai: |
  Korean macro/history column (not investment advice), 2026-09-07, group macro-geo, Key-Currency series.
  ...
  Cases: Athenian drachma, Persian siglos/Sasanian drachm, denarius, wushu, solidus, dinar/dirham, Yuan jiaochao, peso de ocho, Mughal rupee, Ottoman akçe, guilder, pound, USD ($40T debt 2026).
  USD outlook: erosion not collapse; petrodollar is de facto not a 50-year treaty; no alternative (CNY 2% COFER); BTC/stablecoins as liquidity reservoirs; five political signals.
  Closing (not advice): keep some USD assets; conservative AI/hyperscaler valuations (Cisco 2000); gold as insurance not core; India/Africa satellite; Dalio All Weather.
...
이 글은 열두 개의 기축통화가 어떻게 성장했고, 어디까지 통용됐으며, 왜 무너졌는지를 정리한 뒤, 국가부채 40조 달러 시대에 접어든 달러의 운명을 전망하고, 마지막으로 달러 표시 자산을 어떻게 볼 것인지 필자의 생각을 덧붙여 달러의 미래에 대한 담론을 나누고자 한다.

### 한눈에 보는 12개 기축통화

| # | 통화 | 전성기 | 통용 범위 | 지위 유지 | 몰락의 직접 원인 |
| --- | --- | --- | --- | --- | --- |
| 1 | 아테네 드라크마 | BC 5세기 | 에게해·흑해·이집트·시칠리아 | 약 100년 | 은광 상실 + 전비 조달용 변조 |
| 2 | 페르시아 시글로스·사산조 드라크마 | BC 5세기 / 6세기 | 소아시아–인더스, 실크로드–중국 | 220년 / 400년 | 정복(화폐는 정복자에게 상속) |
| 3 | 로마 데나리우스 | 1세기 | 제국 전역, 인도·발트해까지 | 약 480년 | 군단 하사금을 위한 300년 함량 저하 |
| 4 | 한 오수전 | BC 1세기– | 중국·한반도·베트남·실크로드 | 739년 | 사주(私鑄)와 규격 형해화 |
| 5 | 비잔틴 솔리두스 | 6–10세기 | 지중해·이슬람권·러시아·인도 | 약 760년 | 만지케르트 이후 군비 → 순도 저하 |
| 6 | 이슬람 디나르·디르함 | 8–10세기 | 이베리아–인더스, 스칸디나비아 | 약 350년 | 칼리프국 분열 + 은 기근 |
| 7 | 원 교초 | 13세기 말 | 고려–페르시아 | 약 100년 | 준비자산 없는 지폐 증발 |
| 8 | 스페인 페소 데 오초 | 16–17세기 | 유럽·아메리카·중국·인도 | 약 300년 | 전쟁 부채, 4차례 국가 부도 |
| 9 | 무굴 루피 | 17세기 | 인도양 전역 | 약 200년 | 제국 분열, 발행권의 영국 이전 |
| 10 | 오스만 아크체 | 15–16세기 | 발칸–예멘, 흑해·북아프리카 | 약 260년 | 전쟁 → 평가절하 → 예니체리 반란 순환 |
| 11 | 네덜란드 길더 / 영국 파운드 | 17세기 / 19세기 | 유럽·인도양 / 대영제국·세계 무역 60% | 170년 / 130년 | 소국의 한계 / 두 차례 세계대전 부채와 달러와의 경쟁 패배 |
| 12 | 미국 달러 | 20세기 후반– | 사실상 전 세계 | 82년(진행 중) | 국가부채 40조 달러, 전쟁 지출, 재정 규율 — 판정 미확정 |

![기축통화별 지위 유지 기간 막대 그래프](./images/key-currency-tenure.png)

솔리두스와 오수전은 700년을 넘겼고, 아테네와 원은 100년을 못 채웠다. 82년째인 달러는 이 표에서 아직 가장 젊은 통화다. 수명을 가른 것은 국력의 크기가 아니라, 아래에서 반복해서 보게 될 한 가지 약속이었다. 바로 가치를 절하하지 않는다는 믿음이다.



## 1. 아테네 드라크마 — 최초의 국제통화, 최초의 초인플레이션

**성장.** 아테네의 은화 경제는 흔히 솔론의 개혁(기원전 594년)에서 시작됐다고 서술되지만, 이는 후대 아리스토텔레스의 기록에 의존한 전승이며 아테네에서 본격적인 은화가 주조된 것은 기원전 6세기 중반 페이시스트라토스 시기로 보는 것이 정설이다(주1). 확실한 것은 아테네가 초기 아이기나 표준을 버리고 더 가벼운 에우보이아-아티카 표준을 채택했고, 이 표준이 동방 교역의 결제 기준이던 페르시아 시글로스와 쉽게 환산되는 무게 비율을 가졌다는 점이다. 

동방 무역의 중심지인 페르시아가 무게를 맞춘 것이 아니라 아테네가 기존 결제망에 접속할 수 있는 은의 가치와 무게를 택한 것이고, 자국 화폐를 고립시키지 않고 더 큰 결제망과 연결한 것이 속칭 부엉이 은화라고 불리는 드라크마, 아테네 여신의 은화 성공의 첫 조건이었다. 순은 약 4.3g의 1드라크마는 숙련 노동자의 하루 품삯이었다. 그리스가 은화 경제권으로 전환된 것은 기원전 483년 라우리움 은광의 대규모 광맥 발견이었다. 테미스토클레스는 이 은으로 함대를 건조해 살라미스에서 페르시아를 꺾었고, 이후 아테네는 델로스 동맹을 자국 경제권과 재정으로 흡수했다. 기원전 449년경 동맹국에 아테네 화폐·도량형 사용을 강제했다고 전해지는 '주화 법령'(Coinage Decree)(주2)을 내리면서 '부엉이 은화'는 지중해 최초의 사실상 기축통화가 됐다.
...
아테네 이후의 사례들도 군사·재정·통화의 쇠퇴가 서로를 가속하는 같은 순환을 보여준다. 다만 순서는 매번 다르다. 아테네는 은광 상실이, 로마와 오스만은 화폐 변조가, 스페인은 재정 파탄이 먼저였다. 어느 것이 먼저든 세 톱니가 맞물리기 시작하면 멈추지 않는다는 점이 공통이다.

## 2. 페르시아 은화 — 2,500년을 이어온 동방의 무역 화폐

아테네가 27년 전쟁으로 무너진 뒤에도, 아테네가 환산 기준으로 삼았던 상대편 은화는 살아남았다. 페르시아 은화는 기원전 6세기 아케메네스 왕조부터 20세기 초 카자르 왕조까지 약 2,500년에 걸쳐 여러 왕조에서 발행됐고, 그중 아케메네스와 사산조 두 시기는 명백한 기축통화의 역할을 했다. 페르시아는 흔히 정복 제국으로 기억되지만, 실제로는 왕의 길(Royal Road)과 페르시아만·인도양 항로를 장악한 무역 국가였고, 은화는 그 교역망의 결제 수단이었다. 무역과 교역의 중심지였기 때문에 표준화된 은화는 긴 시간 생명력을 가질 수 있었던 것이다.
...
3세기 위기(235–284년) 동안 은 순도는 5% 아래로 떨어졌다. 디오클레티아누스가 301년 최고가격령으로 물가를 통제하려 했지만 실패했고, 시장은 물물교환과 현물 납세로 회귀했다. 도시민은 식량을 찾아 농촌으로 흘러갔고, 이들이 대토지 예속민(콜로누스)이 되면서 중세 농노제의 원형이 만들어졌다. 476년 서로마의 종언은 정치적 사건이지만, 그 토대는 이미 통화 붕괴로 물류와 무역이 무너진 상태였다.
...
## 6. 이슬람 디나르와 디르함 — 지브롤터에서 인더스까지, 중세의 달러
...
## 7. 원나라 교초 — 동양 최초의 지폐 기축통화

**성장.** 1260년 쿠빌라이는 은과 비단을 준비자산으로 삼는 지폐 중통교초(中統交鈔)를 발행했다. 원은 민간의 금·은 유통을 금지하고 교초로 강제 환수해 지폐 단일 체제를 만들었다. 몽골 제국의 역참망을 타고 교초는 고려에서 페르시아까지 통용되는 최초의 지폐 기축통화가 됐다(주6). 마르코 폴로는 "**종이 조각이 순금처럼 받아들여진다**"며 경탄했고, 위조범은 사형에 처한다는 경고가 지폐에 인쇄돼 있었다.

**통용 지역.** 원 본토, 고려, 일칸국(페르시아, 1294년 '차오'라는 이름으로 발행 시도), 중앙아시아 교역로.

**쇠락의 원인.** 준비자산 없는 증발이었다. 1287년 지원초(至元鈔)를 발행하며 구권 대비 1:5 평가절하를 단행했고, 이후 대외 원정·황실 지출·불교 사원 시주를 위해 지폐를 계속 찍었다. 1350년 지정초(至正鈔) 개혁 때는 이미 물가가 수십 배 뛰어 있었고, 원 조정은 1365년 사실상 교초제를 포기했다. 통화 붕괴는 홍건적의 난과 주원장의 발흥으로 이어졌고, 1368년 원은 몽골 초원으로 밀려났다(주3).

## 8. 스페인 페소 데 오초 — 은이 넘쳐도 파산한 제국
...
## 9. 무굴 루피와 오스만 아크체 — 인도양과 지중해의 마지막 은화 제국
...
제국은 전쟁으로 지역 패권을 잡고, 무역으로 그 통화의 영향력을 키운다. 그리고 국력을 소진하는 전쟁으로 패권을 잃으면서, 황금알을 낳는 거위를 제 손으로 잡듯 기축통화를 몰락시킨다.
...
## 10. 네덜란드 길더와 영국 파운드 — 근대 금융 패권의 두 얼굴
...
## 11. 미국 달러 — 금태환 중지 55년, 국가부채 40조 달러
...
요약하면 금환본위 달러는 '실물로 보증된 지폐'였고, 페트로달러는 '수요 구조로 보증된 지폐'다. 전자는 순금이 있었고 후자는 보증되는 기초 자산이 없다. 역사상 처음으로 금이나 은의 뒷받침 없이, 오직 결제 수요와 시장 인프라만으로 유지되는 기축통화가 탄생한 것이다. 이 차이가 중요한 이유는 뒤에서 보듯 몰락의 방식을 결정하기 때문이다. 함량이 있는 화폐는 함량이 바닥나면 붕괴하지만, 기초 자산이 없는 화폐는 수요가 이탈하는 만큼만 침식된다. 여기서 한 가지 정리해 둘 것이 있다. 1974년의 미-사우디 합의는 만료 조항이 있는 정식 조약이 아니다. 2024년 6월 "50년 페트로달러 협약이 만료됐다"는 이야기가 퍼졌지만, 그런 조약은 존재한 적이 없다(주7). 페트로달러는 문서로 유지된 적이 없고, 양국 정상의 만남과 안보·투자 약속을 통해 비공식적으로 갱신되는 사실상의 표준(de facto standard)이다. 사우디가 위안 결제를 검토한다는 보도가 반복돼도 실제 결제는 달러로 이뤄지는 이유는, 현재의 달러 금융망에서 달러의 범용성을 대체할 수단이 없기 때문이다. 원유의 비달러 결제는 이란·러시아처럼 달러 결제망에서 배제된 국가에서만 실제로 작동하며, 그것도 상대국(중국·인도)의 통화로 받은 대금을 다시 쓸 곳이 마땅치 않다는 문제를 안고 있다. 조약이 없기에 폐기될 것도 없고, 대안이 없기에 이탈할 곳도 없다. 그것이 페트로달러가 반세기를 버틴 방식이다. 다만 셰일 혁명으로 미국이 원유 순수출국이 되면서 이 구조의 무게중심은 석유에서 국채와 스테이블코인으로 옮겨가고 있고, 그것이 세 번째 달러다.
...
![달러 준비통화 비중과 미국 국가부채 추이 1999–2026](./images/usd-share-vs-debt.png)

두 곡선이 정확히 반대로 움직인다. 1999년 71%였던 달러 비중이 57%로 내려오는 동안 부채는 5.7조 달러에서 40조 달러로 7배가 됐다. 2014–2016년의 반등은 유로 위기와 신흥국 통화 약세로 인한 평가 효과였고, 추세를 바꾸지는 못했다.
...
**전쟁이라는 누수.** 역대 기축통화 발행국을 무너뜨린 가장 큰 지출 항목은 전쟁이었고, 미국도 예외가 아니다. 9·11 이후 아프가니스탄·이라크를 비롯한 '테러와의 전쟁'에 미국이 쓴 돈은 브라운대 '전쟁 비용' 프로젝트 추산으로 향후 참전군인 의료비까지 합쳐 약 8조 달러에 달한다(주4). 

20년간 복수와 친미 국가 건설에 쏟은 이 돈은 도로도 공장도 남기지 않았고, 아프가니스탄은 2021년 탈레반에 그대로 돌아갔다. 국력과 재정을 소진하고도 결과가 없었다는 점에서 아테네의 시칠리아 원정과 스페인의 네덜란드 80년 전쟁을 떠올리게 한다. 그리고 2026년 2월 28일 시작된 이란 전쟁에는 7월까지 375억 달러가 투입됐고, 행정부는 전쟁 비용 보전을 위해 876억 달러의 추가 예산을 요청했으며, 2027회계연도 국방예산은 사상 최대인 1조 5천억 달러로 편성됐다(주5).

 이자 지출이 이미 국방비를 넘어선 상태에서 국방비를 44% 늘리는 것은, 펠로폰네소스 전쟁 말기 아테네가 은광을 잃은 채 함대를 다시 짓던 장면과 겹친다. 문제는 전쟁 비용의 절대액이 아니다. 기축통화 발행국은 남의 저축으로 전쟁을 치를 수 있기에 전쟁을 멈출 유인이 약하고, 그 특권이 재정 규율을 잠식하는 데 쓰인다는 점이다.
...
**둘째, 대안이 없다는 사실이 달러를 지탱하고 있다.** 기축통화 교체는 도전자가 준비됐을 때 일어난다. 길더를 대체한 것은 런던의 금융시장이었고, 파운드를 대체한 것은 뉴욕이었다. 유로는 재정 통합이 없고, 위안은 자본 통제와 법치 리스크로 준비통화 비중이 2%에 갇혀 있다. 금은 결제 통화가 아니고, 비트코인은 변동성이 크다. 현재의 '탈달러화'는 달러에서 특정 통화로의 이동이 아니라, 달러에서 금·비전통 통화·복수 통화 바스켓으로의 '분산'이다. 이것은 달러 패권의 종말이 아니라 달러 '독점'의 종말이다. 2026년 이란 전쟁이 이를 증명했다. 미국이 전쟁 당사자였는데도 달러는 강세로 돌아섰고 금은 오히려 하락했다. 위기가 오면 세계는 여전히 달러로 도망친다.
...
세 번째 저수지는 오래됐지만 여전히 거대하다. 미국의 초고가 부동산과 자산 시장이다. 걸프 왕가와 중동의 부호, 남미의 부패 정치인, 중국의 부유층, 러시아의 올리가르히는 자국의 정치 리스크와 자본 통제를 피해 맨해튼·마이애미·베벌리힐스의 부동산과 미국 국채·주식에 돈을 묻는다. 이들에게 달러 자산은 수익을 위한 투자가 아니라 정치 리스크로부터의 망명지다. 
...
**반론을 먼저 듣자.** '침식' 결론에 이르기 전에 반대편 논거 세 가지를 짚는다. 첫째, 배리 아이켄그린이 지적하듯 1920년대는 파운드·달러·프랑이 준비자산을 나눠 가진 다극 체제였고, 1945년 이후의 달러 독점이 오히려 역사적 예외였다. 이 시각에서 지금의 '분산'은 몰락이 아니라 정상으로의 회귀다. 둘째, 달러 비중 하락의 상당 부분은 환율 평가 효과다. 유로·엔이 달러 대비 강세인 해에는 달러 비중이 기계적으로 줄고, 실제 매도 없이도 수치가 움직인다. 위 차트의 2014–2016년 반등이 그 증거다. 셋째, 일본이다. 부채/GDP 230%에서 30년을 버텼고 엔은 무너지지 않았다. 국내 저축이 국채를 흡수하는 한 부채 총량은 통화를 죽이지 않는다는 반증이다. 미국은 국내 저축률이 일본보다 낮고 외국인 보유 비중이 높다는 차이가 있지만, 그 차이를 스테이블코인과 자산 시장이 메우고 있다는 것이 본문의 논지이기도 하다. 세 반론 모두 '붕괴론'을 기각하는 데는 유효하다. 그러나 어느 것도 '단일 기축통화 지위의 침식'까지 부정하지는 못한다.
...
대체재가 없는 통화는 가치가 급격히 절하되더라도 쉽게 무너지지 않는다. 그러나 '유일한' 기축통화라는 지위는 이미 잃어가고 있고, 그 속도는 40조 달러의 부채가 아니라 워싱턴이 그 부채를 어떻게 다루는가, 특히 전쟁을 멈출 수 있는가와 연준을 내버려 둘 수 있는가에 달려 있다. 무역의 통화였던 기축 통화의 경우 제국이 몰락하더라도 살아 남은 전례에 비추어 볼 때 달러는 무역과 금융으로 인해 장기 생존이 가능할 것이다.
...
## 달러 표시 자산, 어떻게 고민해야 할까?

여기까지가 역사이고, 아래는 필자의 생각이다. 투자 권유가 아니라 이 글을 쓰면서 정리한 관점이다.

**넘친 달러는 가상화폐만 키운 게 아니다.** 2008년 이후 풀린 달러 유동성이 흘러간 가장 큰 저수지는 사실 나스닥이었다. 애플·마이크로소프트·엔비디아·구글·아마존·메타의 시가총액 합계가 유럽 전체 증시를 넘어선 것은 미국 혁신 기업의 실력이기도 하지만, 세계의 달러가 갈 곳을 찾다 도착한 종착지이기도 하다. 달러 체제가 침식되더라도 그 유동성이 하루아침에 사라지지는 않는다. 이 관점에서 달러 표시 자산을 일부 유지하는 것은 맞다. 달러 붕괴론에 올라타 달러 자산을 전부 비우는 것은, 침대에 벼룩이 있다고 침대를 불태우는 우를 범하는 것과 같다. 

**미국의 AI 혁명은 시작 단계다.** 그래서 주목해야 한다. 그러나 지난 24개월간 AI 관련주는 나스닥의 연간 상승률 대비 수십 배로 뛰었고, 이 정도 속도는 언제라도 되돌아올 수 있다. 여기서 기억할 이름은 시스코다(주9). 닷컴 시대의 시스코는 실적이 나쁜 회사가 아니었다. 인터넷 네트워크를 연결하는 장비를 팔았고 매 분기 매출이 늘었으며 2000년 3월 세계 시가총액 1위에 올랐다. 그리고 주가는 그 뒤 26년 동안 고점을 회복하지 못했다. 사업이 실패해서가 아니라, 미래 25년치 성장이 이미 가격에 들어 있었기 때문이다. 오늘의 하이퍼스케일러는 시스코와 같은 자리에 서 있다. AI 인프라의 배관을 팔고, 실적은 좋고, 밸류에이션은 시장 성장률이 조금만 꺾여도 크게 다칠 위치에 있다. 미래를 믿는 것과 그 미래에 지금 가격을 지불하는 것은 다른 문제다. 보수적으로 접근해야 하는 이유다.

**지루하게 금을 사라는 것은 정답이 아니다.** 기축통화 몰락사를 읽고 나면 금을 사고 싶어지는 것이 정상이다. 그러나 1980년 1월 온스당 850달러에 금을 산 사람은 명목 가격이 그 수준을 회복하는 데 28년을 기다려야 했고, 물가를 감안한 실질 가치는 2011년까지도 돌아오지 않았다(주8). 금은 통화 신뢰가 무너지는 국면에서는 최고의 자산이고, 신뢰가 유지되는 긴 국면에서는 이자도 배당도 없는 돌덩이다. 본문의 결론이 '붕괴가 아니라 침식'이라면 금은 보험이지 주력이 아니다. 다섯 신호 중 세 개가 켜지기 전까지는 더욱 그렇다. 코로나 이후 금값은 급등했고, 그 뒤에는 상하이 금거래소를 통한 중국 개인투자자의 레버리지 단타 수요가 있었다. 그리고 2026년 봄, 금은 고점 대비 30% 하락해 온스당 4,000달러 아래로 밀렸고, 중국 은행들은 소매 마진 거래를 중단했다.(주10) 통화 불신의 상징인 금조차 투기 자금이 들어오면 투기 자산처럼 움직인다는 사실을 확인한 셈이다. 금이 보험이라면 보험료가 싼 시점에 사야 하고, 열풍의 정점은 그 시점이 아니다.

**인구와 시장이 성장하는 곳에 고위험 투자를 일부 담아야 한다.** 페르시아·이슬람·무굴 사례가 보여주듯 기축통화는 무역의 무게중심을 따라 이동했다. 다음 세대의 무역 무게중심은 인구가 늘고 소비 시장이 만들어지는 인도와 아프리카, 동남아시아에 있다. 이 지역의 통화·정치·법치 리스크는 크고, 그래서 '일부'다. 그러나 달러 침식이 앞으로 한 세대 동안 천천히 일어나는 과정이라면, 그 20년 동안 성장할 시장에 자리를 잡아두는 것이 침식에 대비하는 실질적 방법이다. 금은 침식을 견디게 하고, 성장 시장은 침식 이후를 준비하게 한다.

**레이 달리오의 올웨더를 고민해야 할 때다.** 달리오가 올웨더 포트폴리오를 설계한 출발점이 바로 이 글의 주제, 즉 기축통화와 제국의 순환이었다. 성장·인플레이션이 각각 오르고 내리는 네 국면 어디에서도 무너지지 않도록 주식·장기채·원자재·금을 위험 기여도 기준으로 나눠 담는 방식이다. 이 글이 말하는 세계, 즉 달러가 당장 죽지는 않지만 서서히 침식되고, AI가 성장을 이끌지만 그 가격이 위험하며, 금이 보험이되 주력은 아니고, 신흥 시장이 다음 무게중심인 세계에서는 어느 한 자산에 베팅하는 것보다 국면별로 버티는 구조가 맞다. 정확한 비율은 각자의 몫이지만, 방향은 그렇다.

정리하면 이렇다. 달러 자산은 유지하되 전부는 아니고, AI는 주목하되 하이퍼스케일러 밸류에이션에는 보수적으로, 금은 최종 안전자산, 보험으로, 인도·아프리카는 고위험 성장 자산으로 일부, 그리고 전체는 올웨더의 균형으로. 기축통화 2,500년의 역사가 개인 투자자에게 주는 교훈은 어느 통화가 이길지 맞히라는 것이 아니라, 어느 통화가 이기든 살아남을 구조를 만들라는 것이다.

"**강한 자가 살아남는 것이 아니라 살아남는 자가 강한 자다**" - 영화 '황산벌'(2003년)에서

찰스 다윈은 『종의 기원』에서 "가장 강한 종이 아니라 환경 변화에 가장 잘 적응하는 종이 살아남는다"라고 주장했다. 우리는 살아 남는 미래에 투자해야 한다. 그것이 단 하나의 가능성이 아니기에 열린 마음으로 페트로 달러의 가치 하락에 대비하고 미래를 상상해야 한다.

---

### 주석 및 출처

(주1) 솔론의 화폐 개혁은 아리스토텔레스 『아테네 정치제도사』 10장에 기록돼 있으나, 고고학적으로 아테네 최초의 주화(Wappenmünzen)는 기원전 550년경, 부엉이 은화는 기원전 510년경으로 편년된다. 솔론 당시 아테네에 주화가 없었다는 것이 현재 화폐사학계의 다수설이다. 참고: C. Kraay, *Archaic and Classical Greek Coins* (1976); J. Kroll, "Silver in Solon's Laws" (1998).

(주2) 흔히 '클레아르코스 법령'으로 불리는 아테네 주화 법령의 연대는 기원전 449년설과 420년대설이 대립하며, 그 실효성과 존재 자체도 논쟁 대상이다. 본문은 통설을 따랐다. 참고: R. Meiggs & D. Lewis, *Greek Historical Inscriptions* no. 45; H. Mattingly, *The Athenian Empire Restored* (1996).

(주3) 흔히 인용되는 "1380년 지폐 1장 = 동전 1,000개 → 1535년 0.28개" 수치는 원의 교초가 아니라 명의 대명보초(大明寶鈔) 사례다. 명은 원의 교훈을 무시하고 1375년부터 준비금 없는 지폐를 찍었고 160년 만에 가치가 사실상 0이 됐다. 원의 교초는 1365년 사실상 폐지, 원은 1368년 멸망. 참고: 리처드 폰 글란, *Fountain of Fortune* (1996).

(주4) Brown University Watson Institute, "Costs of War" Project. 2001–2022년 미국의 9·11 이후 전쟁 총비용 추산 약 8조 달러(향후 참전군인 의료·복지 비용 포함).

(주5) 2026년 9월 기준 언론 보도. 이란 전쟁 비용 375억 달러는 2026년 7월 21일 헤그세스 국방장관의 상원 세출위 증언, 876억 달러 보충예산안은 2026년 6월 24일 의회 제출, 2027회계연도 국방예산 1조 5천억 달러는 2026년 4월 백악관 예산관리국 발표 기준. 전쟁이 진행 중이므로 이 수치는 갱신될 수 있다.

(주6) 세계 최초의 지폐는 원 교초가 아니라 북송의 교자(交子, 1024년 관영화)와 남송의 회자(會子)다. 다만 송의 지폐는 국내 유통에 그쳤고, 국경을 넘어 통용된 최초의 지폐라는 의미에서 본문은 교초를 '최초의 지폐 기축통화'로 표현했다.

(주7) 1974년 6월 미-사우디 '경제협력 공동위원회' 합의는 사우디의 미 국채 매입과 미국의 안보·기술 협력을 교환한 양해 성격의 문서이며, 원유의 달러 결제를 명문화하거나 50년 만료 조항을 둔 조약이 아니다. 2024년 6월 '협약 만료' 보도는 근거가 확인되지 않은 SNS발 주장이다. 참고: D. Spiro, *The Hidden Hand of American Hegemony* (1999).

(주8) 금은 1980년 1월 21일 온스당 850달러(런던 PM 픽스)를 기록한 뒤 2008년 1월에야 명목 기준으로 이 가격을 회복했다. 미국 CPI로 환산한 실질 가격 기준으로는 2011년 9월 고점(약 1,900달러)에서도 1980년 실질 고점(2011년 달러 기준 약 2,400달러)에 못 미쳤다.

(주9) 시스코 시스템즈는 2000년 3월 27일 시가총액 약 5,550억 달러로 세계 1위에 올랐고 주가는 80달러 근처에서 고점을 찍었다. 이후 2002년 8달러대까지 하락했으며, 2026년 현재까지 명목 주가 기준으로 2000년 고점을 회복하지 못했다. 같은 기간 매출은 4배 이상 늘었다.

(주10) 2026년 6월 기준 언론 보도. 현물 금값은 고점 대비 약 30% 하락해 온스당 4,000달러선이 무너졌고, 공상은행·중국은행 등은 7월부터 상하이 금거래소 연계 소매 귀금속 마진 거래를 정지하고 일부 마진 요건을 140%까지 인상했다. 2026년 3월 월간 낙폭 약 12%는 2008년 이후 최대.
...
기타 참고: IMF COFER(2026년 1분기), 미 재무부 부채 통계(2026년 8월 18일, Debt to the Penny), 레이 달리오 『변화하는 세계 질서』(2021), 리처드 폰 글란 『Fountain of Fortune』, 배리 아이켄그린 『Exorbitant Privilege』(2011), 카르멘 라인하트·케네스 로고프 『This Time Is Different』(2009), 필립 그리어슨 『Byzantine Coins』(1982), 셰브케트 파묵 『A Monetary History of the Ottoman Empire』(2000), 이르판 하비브 『The Agrarian System of Mughal India』(1963).
