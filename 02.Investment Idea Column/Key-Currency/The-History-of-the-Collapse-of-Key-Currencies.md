...
대체재가 없는 통화는 가치가 급격히 절하되도라도 쉽게 무너지지 않는다. 그러나 '유일한' 기축통화라는 지위는 이미 잃어가고 있고, 그 속도는 40조 달러의 부채가 아니라 워싱턴이 그 부채를 어떻게 다루는가, 특히 전쟁을 멈출 수 있는가와 연준을 내버려 둘 수 있는가에 달려 있다. 무역의 통화였던 기축 통화의 경우 제국이 몰락하더라도 살아 남은 전례에 비추어 볼 때 달러는 무역과 금융으로 인해 장기 생존이 가능할 것이다.
...
**지루하게 금을 사라는 것은 정답이 아니다.** 기축통화 몰락사를 읽고 나면 금을 사고 싶어지는 것이 정상이다. 그러나 1980년 1월 온스당 850달러에 금을 산 사람은 명목 가격이 그 수준을 회복하는 데 28년을 기다려야 했고, 물가를 감안한 실질 가치는 2011년까지도 돌아오지 않았다(주8). 금은 통화 신뢰가 무너지는 국면에서는 최고의 자산이고, 신뢰가 유지되는 긴 국면에서는 이자도 배당도 없는 돌덩이다. 본문의 결론이 '붕괴가 아니라 침식'이라면 금은 보험이지 주력이 아니다. 다섯 신호 중 세 개가 켜지기 전까지는 더욱 그렇다.
...
정리하면 이렇다. 달러 자산은 유지하되 전부는 아니고, AI는 주목하되 하이퍼스케일러 밸류에이션에는 보수적으로, 금은 보험으로, 인도·아프리카는 고위험 성장 자산으로 일부, 그리고 전체는 올웨더의 균형으로. 기축통화 2,500년의 역사가 개인 투자자에게 주는 교훈은 어느 통화가 이길지 맞히라는 것이 아니라, 어느 통화가 이기든 살아남을 구조를 만들라는 것이다.

"**강한 자가 살아남는 것이 아니라 살아남는 자가 강한 자다**"

이는 독일 시인 베르톨트 브레히트의 시 '살아남은 자의 슬픔'(1944년)의 한 구절인 "강한 자는 살아남는다"에서 비롯된 표현이며, 찰스 다윈의 진화론을 관통하는 단어이다. 영화 '황산벌'(2003년)에서 조직의 존망을 걸고 승부에 나선 김유신 장군의 대사로 남았다. 

우리는 살아 남는 미래에 투자해야 한다. 그것이 단 하나의 가능성이 아니기에 열린 마음으로 페트로 달러의 몰락에 대비하고 미래를 상상해야 한다.
