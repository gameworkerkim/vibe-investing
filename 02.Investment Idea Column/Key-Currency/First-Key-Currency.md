...
서구에서는 만유인력을 발견한 아이작 뉴턴이 1699년부터 사망할 때까지 약 30년 동안 영국의 **왕립 조폐국장**을 맡아 동전의 끝에 주름을 발명한 이후 돈의 가장 자리를 깎아내는 일이 사라졌다. 영국은 당시 유통되던 화폐의 10%가 위조 화폐일 정도로 문제가 심각했다고 한다. 동전 가장자리에 톱니바퀴 모양의 홈(Milling)을 파서 은을 깎아내는 위조 행위를 원천 차단하는 아이디어를 도입하는 등 화폐 개혁을 통해 국가 재정을 안정 시켰다. 마지막 연금술사라는 별명답게 뉴턴은 금화 주조를 표준화하여 국가 재정을 안정 시켰다고 한다.
