...
일본의 잠재 성장율과 성장 기대감은 낮아졌고 잃어버린 30년 동안 일본의 실질 임금은 오르지 않았다. 한국의 편의점 알바 일당보다 일본의 어느 지방 일당이 확연하게 저렴하다. 우리는 일본의 저렴함에 이끌려 관광을하고 있지, 부와 와패니즘에 매료되지 않고 있는 것이 바로 일본 경제의 쇠락 때문이다.
...
디오클레티아누스(재위 284–305)는 세간의 평과가 달리 화폐를 망친 황제가 아니라, **이미 망가진 화폐를 수습하려다 실패한 황제**다. 그는 3세기 위기를 수습하고 제국을 재편한 통치자였고, 화폐 개혁과 함께 301년 **최고가격령(Edictum de pretiis)**을 반포해 물가를 법으로 묶으려 했다.
...
SpaceX가 만일 유럽의 증시에 상장한다고 했다면 일론 머스크는 차등 의결권을 비롯하여 당야한 주식에 부여된 권리를 얻지 못했을 것이다. 그리고 규제보다도 원하는 만큼의 투자 자금을 IPO에서 얻기 힘들었을 것이다. 
...
두 번째 순환이 첫 번째보다 강하다. 첫 번째는 협정과 관행에 의존하지만, 두 번째는 수익률에 의존하기 때문이다. 지금 나스닥보다 더 수익율 좋은 투자 시장은 찾아보기 힘들다.
...
**그래서 달러의 위기는 붕괴가 아니라 기치의 침식의 형태로 온다.** 어느 날 무너지는 것이 아니라, 무역과 결제 채널이 하나씩 분화되고, 준비 자산이 조금씩 다변화되고, 관행의 구속력이 조금씩 약해지는 방식이다. 시장은 그것을 사건으로 인식하지 못한다. 단기적인 주식 시장의 불안으로 표현될 뿐, 뉴스가 되지 않기 때문이다.
