...
문제는 이 선택이 "옳은가"가 아니라, **이런 선택이 합리적이 되는 사법 시스템이 정상인가?**다. 무죄를 주장하는 피고인이 정당한 재판보다 밀항을 택하는 것이 기대값상 우월하다면, 그 시스템은 이미 실패한 것이다. 곤의 탈주는 일본 사법을 향한 국제사회의 신뢰 투표였고, 결과는 불신이었다.
