---
title: "키옥시아 주식 시황 — 매출과 영업이익은 늘었지만 시장 기대치 하회. 얼마나 더 잘해야 하나?"
subtitle: "사상 최대 실적과 고점 대비 60% 하락 — AI 낸드 호황 속 메모리 업계의 구조적 역설"
description: "키옥시아 FY2026 1분기 영업이익 28배 증가에도 컨센서스 하회. SK하이닉스·마이크론·샌디스크와 함께 읽는 AI 낸드 사이클의 질문."
abstract: |
  키옥시아홀딩스 FY2026 1분기(4~6월) 영업이익 1조 2,700억 엔(전년 대비 약 28배)을 기록했으나 시장 예상치를 하회했다.
  AI eSSD 수요로 ASP가 급등했음에도 주가는 고점 대비 60% 가까이 하락했고, SK하이닉스·마이크론도 같은 패턴이다.
  시장 질문은 실적이 아니라 AI 메모리 호황의 지속 가능성·NAND 피크아웃·YMTC 경쟁이며, 시나리오 A/B/C로 정리한다.
summary_for_ai: |
