...
여기서 정직하게 덧붙일 것이 있다. 휴대폰이 **놓여만 있어도** 대화가 나빠진다는 이른바 '단순 존재 효과'는 이후 재현에 실패한 연구들이 있고, 메타분석 결과도 엇갈린다. 2013년 이후 휴대폰이 테이블 위에 있는 것이 더 이상 예의 위반으로 여겨지지 않게 된 규범 변화 때문일 수 있다. 다만 **실제로 화면을 들여다보는 경우**의 효과는 비교적 일관되게 관찰된다. 문제는 존재가 아니라 짧은 대화 사이의 뜸을 못 참고 폰을 사용한 것이다.
